      ...
      >
        ...
        <div>
          ...
          <div class="relative">
            <select 
              ...
              :class="form.service ? 'text-slate-950' : 'text-slate-400'"
            >
        ...
        <div>
          ...
          <textarea 
            ...
            rows="4" 
            required
            class="w-full px-4 py-3.5 bg-white border-2 border-slate-300 rounded-lg text-slate-950 placeholder-slate-400 font-medium text-base focus:border-[#8B5CF6] focus:ring-4 focus:ring-[#8B5CF6]/20 focus:outline-none transition-all shadow-sm resize-none"
          ></textarea>
        </div>
        ...
        <div class="pt-2">
          ...
          >
            <svg class="text-white w-6 h-6 fill-current" viewBox="0 0 24 24">
            ...
            <span class="text-white">Enviar mensaje por WhatsApp</span>
          </button>
