<template>
  ...
  >
      ...
      <div class="flex justify-between items-center nav-inner" style="height:var(--header-height)">
        ...
        <div class="flex items-center gap-4">
          ...
          <button 
            ...
            class="md:hidden p-2 text-white rounded focus:outline-none focus:ring-2 focus:ring-primary/50"
            title="Abrir menú"
          >
    ...
    <div 
      v-if="mobileMenuOpen" 
      id="nav-mobile"
      class="md:hidden bg-black/90 backdrop-blur-xl border-t border-white/10 shadow-lg"
      v-motion
...
<style scoped>
/* Navbar layout variables and improved styles */
.nav {
  --header-height: 92px;
}
